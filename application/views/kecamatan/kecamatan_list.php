		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kecamatan/update/'.$kecamatan->id_kecamatan),'<span class="label label-info">Ubah</span>'); 
				echo ' | '; 
				echo anchor(site_url('kecamatan/delete/'.$kecamatan->id_kecamatan),'<span class="label label-danger">Hapus</span>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
